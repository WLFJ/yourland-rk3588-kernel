...
#define TSK_STACK_CANARY 1344 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 5792 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 6760 /* offsetof(struct task_struct, thread.sctlr_user) */
...
#define MM_CONTEXT_ID 1120 /* offsetof(struct mm_struct, context.id.counter) */
...
#define VCPU_CONTEXT 480 /* offsetof(struct kvm_vcpu, arch.ctxt) */
#define VCPU_FAULT_DISR 2336 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_WORKAROUND_FLAGS 2344 /* offsetof(struct kvm_vcpu, arch.workaround_flags) */
#define VCPU_HCR_EL2 2296 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
